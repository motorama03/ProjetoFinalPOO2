...
public class Graph implements GraphInterface { 
	 ...
	 */
    public void imprimirGrafo(Class<? extends ScreenGeneric> classe){
    	JFrame frame = new JFrame();
        Container content = frame.getContentPane();
    ...
    public void imprimirGrafoCircular() {
    	imprimirGrafoCircle();
    }
	...
	/**
	 * @author Mateus Brandl
	 * @return Retorna todos os vertices.
	 * @param 
	 */
	public List<Vertex> getAllVertices() {
	    List<Vertex> vertices = new ArrayList<>();
	    for (Vertex vertex : graphVertex.values()) {
	        vertices.add(vertex);
	    }
	    return vertices;
	}
